...
func TestMin(t *testing.T) {
	...
	tests := []struct {
		...
		{a.C(), NewArray64([]float64{0}), []int{}},
		{a.C(), Arange(0, 10).Reshape(5, 2), []int{0}},
		{a.C(), NewArray64([]float64{0, 1, 10, 11}, 2, 2), []int{1}},
		{a.C(), Arange(0, 20, 2).Reshape(2, 5), []int{2}},
		{a.C(), NewArray64([]float64{0, 10}), []int{1, 2}},
	}
	for i, v := range tests {
		if c := v.a.Min(v.ax...).Equals(v.b); !c.All().At(0) {
