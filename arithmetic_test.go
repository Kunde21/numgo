...
func TestAddC(t *testing.T) {
	...
	if b := a.Array64().AddC(2).Equals(Arange(2, 22)); !b.All().At(0).(bool) {
...
func TestMultC(t *testing.T) {
	...
	if b := a.MultC(2).Equals(Arange(0, 40, 2).values()); !b.All().At(0).(bool) {
		t.Log(b)
		t.Log(a)
		t.Fail()
	}
...
func TestDivC(t *testing.T) {
	t.Parallel()
	a := Arange(0, 40, 2)
	if b := a.DivC(2).Equals(Arange(21)); !b.All().At(0).(bool) {
		t.Log(b)
		t.Log(a)
		t.Fail()
	}
...
func TestPowC(t *testing.T) {
	t.Parallel()
	a := Arange(0, 40, 2)
	if b := a.PowC(0).Equals(FullArray64(1, 21)); !b.All().At(0).(bool) {
		t.Log(b)
		t.Log(a)
		t.Fail()
	}
...
func TestAdd(t *testing.T) {
	...
	if !c.Equals(Arange(0, 38, 2).Reshape(2, 10)).All().At(0).(bool) {
	...
	tst.Add(Arange(1, 5))
	runtime.GC()
	if e := a.Equals(tst); !e.All().At(0).(bool) {
		t.Log(e.data)
		t.Log(Arange(1, 5))
		t.Log(Arange(20))
		t.Log(a.Flatten())
...
func TestDiv(t *testing.T) {
	...
	a.Div(a)
	if e := a.Equals(FullArray64(1, 200)); e.All().At(0).(bool) {
		t.Log(e)
		t.Fail()
	}
...
func TestPow(t *testing.T) {
	...
	a.Reshape(2, 25, 4)
	a.Pow(FullArray64(0, 4))
	if e := a.Equals(FullArray64(1, 2, 25, 4)); !e.All().At(0).(bool) {
		t.Log(e)
		t.Fail()
	}
	if a.HasErr() {
...
func TestFMA12(t *testing.T) {
	...
	c.MultC(2)
	c.Add(a)
	if e := b.Equals(c); !e.All().At(0).(bool) {
		t.Log(a, "\n", b, "\n", c)
		t.Fail()
	}
